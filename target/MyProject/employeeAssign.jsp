...
<title>Employee Assign Page</title>
<style>
  body {
    margin: 0;
    padding: 0;
  ...
  <div class="offset">
    ...
    <table class="pure-table pure-table-horizontal">
      ...
      <%List<String> projectDatas = 
                (List<String>)request.getAttribute("project");
        String project = projectDatas.get(0);
    ...
    <center>
      <table class="pure-table pure-table-horizontal">
        ...
        <tbody>
        <%for (int index = 1; index < projectDatas.size(); index++) {
              String employee = projectDatas.get(index);
        ...
        <form action="ProjectController" method="post">
          <tr style="font-size: 20px;">
            ...
            <td><center><input type="checkbox" name="employees" 
                value="<%=employeeList[0]%>"></center></td>
          </tr>
        <%}%>
        </tbody>
      </table>
  
      <input type="hidden" name="action" value="assignEmployeesToProject">
      <input type="hidden" name="id" value="<%=projectList[0]%>">
