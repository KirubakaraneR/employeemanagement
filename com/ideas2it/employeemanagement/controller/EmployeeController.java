...
public class EmployeeController {
    ...
    public void createEmployeeAddress(String id, String doorNumber, 
            ...
            String addressType) {
        employeeService.createEmployeeAddress(id, doorNumber, street,  
    ...
    public boolean addAddress(String id, String doorNumber, 
            ...
            String state, String country, int pinCode, 
            String addressType) {
        return employeeService.addAddress(id, doorNumber, street,  
                nagar, city, district, state, country, pinCode, 
                addressType);
    }
    ...
    public boolean deleteIndividualAddress(int id) {
        return employeeService.deleteIndividualAddress(id);
    }
    ...
    public boolean checkAddressIdExistOrNot(int id) {
        return employeeService.checkAddressIdExistOrNot(id);
    }
